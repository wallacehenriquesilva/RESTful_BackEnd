...
require_once 'service/OrientadorPublicacaoService.php';
require_once 'service/AlunoPublicacaoService.php';
...
$app->get('/api/publicacao', function () {
    $publicacaoService = new PublicacaoService(new OrientadorPublicacaoBusiness());
