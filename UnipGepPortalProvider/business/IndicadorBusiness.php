...
class IndicadorBusiness
{
    ...
    public function findAll($id)
    {
        $query = "SELECT (SELECT COUNT(*) FROM Aluno "
            . "WHERE idInstituicao = $id ) AS totalAluno, "
            . "(SELECT COUNT(*) FROM Curso "
            . "WHERE idInstituicao = $id) AS totalCursos, "
            . "(SELECT COUNT(*) FROM Orientador "
            . "WHERE idInstituicao = $id) AS totalOrientadores, "
            . "(SELECT COUNT(*) FROM Publicacao "
            . "WHERE idInstituicao = $id) AS totalPublicacoes";
